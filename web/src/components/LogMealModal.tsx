...
import { mealsApi, mealTemplatesApi, aiMealApi, foodApi } from '../lib/api';
import FoodSelector from './FoodSelector';
import type { MealTemplate, Meal, MealCategory, MealFoodItem, FoodItem } from '../lib/types';
    ...
    if (isOpen) {
      Promise.all([
        ...
        if (editingMeal) {
          ...
          const t = templatesData.find(tm => tm.id === templateId);
          if (t) {
